  ...
  return (
    ...
    transition={{duration: 0.6, delay: 0.4}}
                    className='max-w-80 mt-3'>
                        Premium car rental services with a wide selection of luxury and everyday vehicles for all your driving
                    </motion.p>
                    <motion.div 
                      initial ={{opacity: 0}}
    whileInView={{opacity: 1}}
    transition={{duration: 0.6, delay: 0.5}} className='flex items-center gap-3 mt-6'>
   ...
   transition={{duration: 0.6, delay:0.4}}
    className='flex flex-wrap justify-between w-1/2 gap-8'>
                <div>
                    <h2 className=' text-gray-800 text-base font-medium uppercase'>Quick Links</h2>
                ...
                <div>
                    <h2 className=' text-gray-800 text-base font-medium uppercase'>Resources</h2>
                    <ul className='mt-3 flex flex-col gap-1.5'>
                ...
                <div>
                    <h2 className=' text-gray-800 text-base font-medium uppercase'>Contact</h2>
                    <ul className='mt-3 flex flex-col gap-1.5'>
                        <li>Mukharji Nagar</li>
                        <li>New Delhi</li>
                        <li>+91 8957275393</li>
