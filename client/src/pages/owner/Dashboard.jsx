...
const Dashboard = () => {
  ...
  const dashboardCards =[
    ...
    {title:"Total Bookings", value: data.totalCars, icon:assets.listIconColored},
  ...
  return (
    <div className='px=4 pt-10 md:px-10 flex-1'>
      <Title title="Admin Dashboard" subTitle="Monitor overall platfrom performance including total cars, bookings, revenue, and recent activities"/>
